...
export function renderBookPreviewDocument(
	...
	return `<!doctype html><html><head><meta charset="utf-8"><title>${title}</title><style>${previewCss(design, readerScale)}</style></head><body><article class="book">${book.sections
